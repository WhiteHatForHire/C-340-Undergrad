/*******************************************
* Programming excercise 70803 *
* Maxwell Stephens *
* 12:30 TTh *
* 70803, 2/2/17 *
*******************************************/
/*
This program inputs the weight (in pounds) and radius (in feet) of a sphere and outputs whether the sphere will sink or float in water. 
*/
...
Input weight of the sphere in pounds.
2
Input radius of the sphere in feet.
2
